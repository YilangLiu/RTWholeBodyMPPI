...
class Bipedal(BaseMPPI):
    ...
    def __init__(self, task='stand') -> None:
        ...
        self.bipedal_pose_qpos = self.model.keyframe("bipedal2").qpos
        self.bipedal_pose_qvel = self.model.keyframe("bipedal2").qvel
        ...
        self.joints_ref = np.tile(np.concatenate((self.bipedal_pose_qpos[7:], self.bipedal_pose_qvel[6:]))[:,np.newaxis], (1,40))
