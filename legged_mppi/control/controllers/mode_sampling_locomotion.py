...
class Mode_Sampling(BaseMPPI):
    ...
    def update(self, obs):
        ...
        updated_actions = actions[np.argmin(costs_sum)]
    ...
    def quadruped_cost_np(self, x, u, x_ref):
        ...
        """
        kp = 10  # Proportional gain for joint error
        kd = 1   # Derivative gain for joint velocity error
